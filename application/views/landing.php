            ...
            <div class="page-heading">
                ...
                <nav class="navbar">
                        ...
                        <div class="header-top-left">
                            ...
                            <a href="#" class="logo">
                                <img src="<?= base_url('assets/kemkes_update.png'); ?>" alt="Logo" style="width: 100px; height: auto; margin-right: 0px;">
                            </a>
                            <!-- <a href="#" class="logo">
                            ...
                            <a href="#" class="logo">
                                <img src="<?= base_url('assets/who_update.png'); ?>" alt="Logo" style="width: 100px; height: auto; margin-right: 20px;">
                            </a>
                            <a href="#" class="logo">
                                <img src="<?= base_url('assets/unicef_update.png'); ?>" alt="Logo" style="width: 50px; height: auto; margin-right: 10px;">
                            </a>
                        ...
                        <div class="row align-items-center">
                            <!-- <div class="d-flex justify-content-center"> -->
                                <div class="col-md-6">
                                    ...
                                    <p id="description"></p>
                                    <a href="https://drive.google.com/file/d/19ia24-1UMzp6qbq6GdKRl37uef6IiaNo/view?usp=sharing" target="_blank"><button class="btn btn-primary" id="download-btn">Download Panduan</button></a>
