                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>District Program, Financing & Policy</h3>
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('home'); ?>">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">District Program, Financing & Policy </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped" id="table1">
                                                <thead>
                                                    <tr>
                                                        <th>District Name</th>
                                                        <th>Number of Supportive Supervisions to Puskesmas</th>
                                                        <th>Number of Puskesmas that have Conducted Supportive Supervision to Posyandu</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                            ...
                                            <table class="table table-striped" id="table1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Number Providing Immunization Services</th>
                                                        <th>Number Able to Reach Zero Dose (ZD)</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped" id="table1">
                                                <thead>
                                                    <tr>
                                                        <th>District Name</th>
                                                        <th>Total Regional Budget (APBD)</th>
                                                        <th>Allocation for Health Programs</th>
                                                        <th>Allocation for Disease Prevention and Control (P2P)</th>
                                                        <th>Allocation for Immunization Programs</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                            ...
                                            <table class="table table-striped" id="table1">
                                                <thead>
                                                    <tr>
                                                        <th>District Name</th>
                                                        <th>Availability</th>
                                                        <th>Link to Access the Policy</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
