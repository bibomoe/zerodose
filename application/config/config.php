...
|
*/
$config['base_url'] = 'http://localhost/zerodozed';
...
$config['sess_time_to_update'] = 300; // Waktu setelah 5 menit session ID akan diperbarui
$config['sess_regenerate_destroy'] = TRUE; // Regenerasi ID session dan hancurkan session lama setelah login

$config['sess_secure'] = TRUE; // Hanya kirim cookie melalui HTTPS
$config['sess_httponly'] = TRUE; // Mencegah JavaScript mengakses cookie
/*
|--------------------------------------------------------------------------
...
*/
$config['csrf_protection'] = TRUE;  // Mengaktifkan CSRF protection
