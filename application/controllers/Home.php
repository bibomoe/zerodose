...
class Home extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['absolute_puskesmas_immunized_2025'] = $this->Dashboard_model->get_puskesmas_immunized_absolute(2025);
        $this->data['absolute_puskesmas_immunized_2026'] = $this->Dashboard_model->get_puskesmas_immunized_absolute(2026);

        $this->data['total_puskesmas'] = $this->Dashboard_model->get_total_puskesmas();
...
// total_districts sudah ada dari sebelumnya
    ...
    private function load_translation_restored($lang) {
        $translations = [
            'en' => [
                ...
                'text_baseline3' => 'DPT-1 Coverage Target for ',
                'children' => ' children',
                'text1' => 'Target Year ',
                ...
                'text5' => 'Number of Zero dose Children candidates ',
                ...
                'tabel2coloumn2' => 'Number of Zero Dose Children reached (ASIK Data)',
                'tabel2coloumn3' => 'Number of Zero Dose Children reached (Manual Data)',
                'tabel2coloumn4' => 'Number of Zero Dose Children reached (Combined Data)',
                'tabel2coloumn5' => 'Zero Dose Children in 2024',
                'tabel2coloumn6' => '% reached (ASIK)',
                'tabel2coloumn7' => '% reached (Manual)',
                'tabel2coloumn8' => '% reached (Combined)',
                ...
                'text19' => 'Zero-Dose Children Outreach Trend (ASIK Data)',
            ...
            'id' => [
                ...
                'text5' => 'Jumlah Anak Belum di Imunisasi DPT-1 ',
    ...
    //     $translations = [
    //         'en' => [
    //             'page_title' => 'Number of Zero Dose Children in 2024 reached',
    //             'page_subtitle' => '',
    //             'filter_label' => 'Select Filter',
    ...
    //             'tabelcoloumn2' => 'Number of Zero Dose Children reached (ASIK Data)',
    //             'tabelcoloumn3' => 'Number of Zero Dose Children reached (Manual Data)',
    //             'tabelcoloumn4' => 'Number of Zero Dose Children reached (Combined Data)',
    //             'tabelcoloumn5' => 'Zero Dose Children in 2024',
    //             'tabelcoloumn6' => '% reached (ASIK)',
    //             'tabelcoloumn7' => '% reached (Manual)',
    //             'tabelcoloumn8' => '% reached (Combined)',
    //             'sort_kejar_asik' => 'Sort by Highest ASIK reached',
    //             'sort_kejar_manual' => 'Sort by Highest Manual reached',
    //             'sort_kejar_kombinasi' => 'Sort by Highest Combined reached',
    //             // --- Tambahkan terjemahan bulan di sini untuk bahasa Inggris ---
    ...
    private function load_translation_grant_implementation_sub_national($lang) {
        $translations = [
            'en' => [
                ...
                'tabel2coloumn5' => 'Allocation (Total CSO)',
            ...
            'id' => [
                ...
                'tabel2coloumn4' => 'Volume',
                'tabel2coloumn5' => 'Alokasi (Total CSO)',
