...
class Home extends CI_Controller {
    ...
    public function grant_implementation() {
        ...
        $total_absorbed_2024 = array_column($data_absorbed_2024, 'total_budget');
        $total_absorbed_2025 = array_column($data_absorbed_2025, 'total_budget');
        $total_absorbed_2026 = array_column($data_absorbed_2026, 'total_budget');
